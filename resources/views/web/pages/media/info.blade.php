        ...
        <div class="container pb-lg-5">
                ...
                <div class="row mt-3">
                    <div class="col-md-9">
                        @if ($mediaItem->isVIdeo())
                            <video src="{{ $mediaItem->getAttachment(false) }}" controls class="img-fluid"
                                id="video_player"></video>
                        @else
                    ...
                    <div class="col-md-3">
                        <div class="d-flex justify-content-start">
                            <div class="">
                                <img src="{{ $mediaItem->author->getAvatar() }}" class="img-fluid rounded-circle" width="60"
                                    title="Author" alt="author image">
                            </div>
                            <div class="pt-2 ml-3">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="comment-form mt-3">
                            <form action="{{ route('media_collection.comment') }}" method="post"> @csrf
                                ...
                                @endif
                                <input type="hidden" class="form-control" name="media_id" value="{{ $mediaItem->id }}"
                                    required>
                                <div class="form-group">
            ...
            @else
                <div class="text-center m-5">
                    <h4 class="p-3">
                        Activate your account to watch or download book or video!
                    </h4>
